    ...
    @can('create proposal')
      <div class="col-0">
        ...
        <div class="col-2 my-custom-btn">
          ...
          <div class="col-2 my-custom-btn">
              <div class="all-button-box">
                  <a href="{{route('proposal.export')}}" class="btn btn-xs btn-white btn-icon-only width-auto">
                        ...
                        <table class="table table-striped mb-0 dataTable">
                            ...
                            @foreach ($proposals as $proposal)
                                <tr class="font-style">
                                    ...
                                    @if(Gate::check('edit proposal') || Gate::check('delete proposal') || Gate::check('show proposal'))
                                        <td class="Action">
                                            @php $proposalID= Crypt::encrypt($proposal->id); @endphp
                                                @can('copy invoice')
                                                <a href="{{ route('proposal.link.copy',[$proposalID]) }}" class="edit-icon bg-info copy_link" data-toggle="tooltip" data-original-title="{{__('Click to copy')}}"><i class="fas fa-link"></i></a>
                                                @endcan
