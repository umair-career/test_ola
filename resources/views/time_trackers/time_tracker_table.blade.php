                            ...
                            @foreach ($day_group->reverse() as $key =>$day_tracks)
                                ...
                                @foreach ($name_group->reverse() as $key =>$name)
                                    ...
                                    <div class="row acc-mainmenu">
                                        <div class="col-3"> <i class="fas fa-plus accodian-plus"></i> {{$key}}</div>
                                    ...
                                    <div class="acc-sub-menu" style="display: none;">
                                        ...
                                        <div class="row acc-sub-menu-div">
                                            ...
                                            <div class="col-1">
                                                ...
                                                <i data-id="{{$t['id']}}" data-is_billable="{{$t['is_billable']}}" data-toggle="tooltip" data-original-title="{{$t['is_billable'] ==1? __('Click to Mark Non-Billable'):__('Click to Mark Billable')}}" class="change_billable fas fa-dollar-sign {{$t['is_billable'] ==1?'doller-billable':'doller-non-billable'}}"></i>
                                                <i class="fas fa-times text-danger mx-2 pointer remove-track " data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-id="{{$t['id']}}" data-url=""></i>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
