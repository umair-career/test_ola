    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create client')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Client')}}" data-url="{{route('clients.create')}}"><i class="fas fa-plus"></i> {{__('Create')}} </a>
            </div>
        @endcan
    </div>
@endsection
                        ...
                        <div class="dropdown action-item">
                            @if($client->is_active == 1)
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="#" class="dropdown-item text-sm" data-url="{{route('clients.reset',\Crypt::encrypt($client->id))}}" data-ajax-popup="true" data-title="{{__('Forgot Password')}}" >
                                        {{__('Reset Password')}}
                                    </a>
                                </div>
                            @else
