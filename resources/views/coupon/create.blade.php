        ...
        <div class="form-group col-md-12">
            ...
            <div class="d-flex radio-check">
                <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <label class="custom-control-label form-control-label" for="manual_code">{{__('Manual')}}</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="auto_code" value="auto" name="icon-input" class="custom-control-input code">
                    <label class="custom-control-label form-control-label" for="auto_code">{{__('Auto Generate')}}</label>
                </div>
            </div>
        </div>
