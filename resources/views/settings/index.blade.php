                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="w-50 float-left">
                                            {{Form::label('signup',__('Enable SignUp'),array('class'=>'form-control-label')) }}
                                            <div class="">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" name="enable_signup" id="enable_signup" {{ $settings['enable_signup'] == 'on' ? 'checked="checked"' : '' }}>
                                                    <label class="custom-control-label form-control-label" for="enable_signup"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
