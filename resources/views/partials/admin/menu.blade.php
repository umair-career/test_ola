                ...
                <ul class="navbar-nav navbar-nav-docs">
                    ...
                    @else
                        ...
                        @endif
                            ...
                            @if(Gate::check('manage product & service'))
                                <li class="nav-item">
                                    <a href="{{ route('productstock.index') }}" class="nav-link {{ (Request::segment(1) == 'productstock')?'active':''}}">
                                        <i class="fas fa-solid fa-cart-plus"></i>{{__('Product Stock')}}
                                    </a>
                                </li>
                            @endif
                                    ...
                                    <div class="collapse {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines')?'show':''}}" id="navbar-crm">
                                        <ul class="nav flex-column">
                                            ...
                                            @if(\Auth::user()->type=='company' || \Auth::user()->type=='client')
                                                <li class="nav-item">
                                                    <a href="{{route('contract.index')}}" class="nav-link {{ (Request::segment(1) == 'contract')?'active':''}}">
                                                        {{__('Contract')}}
                                                    </a>
                                                </li>
                                            @endif
                                        ...
                                        <ul class="nav flex-column">
                                            ...
                                            @endcan
                                                ...
                                                <li class="nav-item {{ (Request::segment(1) == 'time-tracker')?'active open':''}}">
                                                    <a href="{{ route('time.tracker') }}" class="nav-link">{{__('Tracker')}}</a>
                                                </li>
                                                @endif
                        ...
                        @if(\Auth::user()->show_hrm() == 1)
                            @if( Gate::check('manage employee') || Gate::check('manage setsalary'))
                                <li class="nav-item">
                                    ...
                                    <div
                                        class="collapse {{ (Request::segment(1) == 'holiday-calender' || Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'reports-payroll' || Request::segment(1) == 'leavetype' || Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee' || Request::segment(1) == 'document-upload' || Request::segment(1) == 'document' || Request::segment(1) == 'branch' ||
                                                                ...
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div class="submenu-ul {{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'show' :'collapse'}}" id="report-nav" style="">
                                                                        <ul class="nav flex-column">
                                                                            ...
                                                                            @endcan
                                                                                @can('stock report')
                                                                                    <li class="nav-item {{ (Request::route()->getName() == 'report.product.stock.report' ) ? ' active' : '' }}">
                                                                                        <a href="{{route('report.product.stock.report')}}" class="nav-link">{{ __('Product Stock') }}</a>
                                                                                    </li>
                                                                                @endcan
                                                                        </ul>
                                                                    </div>
                    ...
                    @if(\Auth::user()->type!='super admin' && \Auth::user()->type!='client')
                        <li class="nav-item">
                            <a href="{{ url('chats') }}" class="nav-link {{ (Request::segment(1) == 'chats')?'active':''}}">
