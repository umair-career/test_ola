                                    ...
                                    <td class="Action">
                                        <span>
                                            @can('Edit Competencies')
                                                <a href="#" data-url="{{ URL::to('competencies/'.$competency->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Department')}}" class="edit-icon" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fas fa-pencil-alt"></i></a>
                                            @endcan
