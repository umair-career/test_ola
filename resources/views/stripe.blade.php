                    ...
                    <ul class="nav nav-tabs">
                        ...
                        @endif
                            ...
                            @if(isset($admin_payment_setting['is_paymentwall_enabled']) && $admin_payment_setting['is_paymentwall_enabled'] == 'on')
                                <li>
                                    <a data-toggle="tab" id="contact-tab11" href="#paymentwall_payment">{{__('PaymentWall')}}</a>
                                </li>
                            @endif
                    </ul>
                </div>
                <div class="tab-content">
                     @if(!empty($admin_payment_setting) && $admin_payment_setting['is_stripe_enabled'] == 'on' && !empty($admin_payment_setting['stripe_key']) && !empty($admin_payment_setting['stripe_secret']))
                    ...
                    @endif
                         ...
                         @if(!empty($admin_payment_setting) && $admin_payment_setting['is_paymentwall_enabled'] == 'on' && !empty($admin_payment_setting['is_paymentwall_enabled']) && !empty($admin_payment_setting['paymentwall_secret_key']))
                             <div class="tab-pane " id="paymentwall_payment">
                                 <div class="card">
                                     <form class="w3-container w3-display-middle w3-card-4" method="POST" id="paymentwall-payment-form" action="{{ route('plan.paymentwallpayment') }}">
                                         @csrf
                                         <input type="hidden" name="plan_id" value="{{\Illuminate\Support\Facades\Crypt::encrypt($plan->id)}}">
