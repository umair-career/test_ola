    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create form builder')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('form_builder.create') }}" data-ajax-popup="true" data-title="{{__('Create New Form')}}" class="btn btn-xs btn-white btn-icon-only width-auto"><i class="fas fa-plus"></i> {{__('Create')}} </a>
            </div>
        @endcan
    </div>
@endsection
