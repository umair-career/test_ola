                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-top: 15px solid {{$color}};">{{__('ESTIMATION')}}</h1></div>
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{$usr->estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{$usr->dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-2">
                                        <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('To')}}:</strong>
                                            <p data-v-b8f60a0c="">{{$client->name}}</p>
                                            <pre data-v-b8f60a0c="">{{$client->email}}</pre>
                                        </div>
                                    </div>
                                </div>
                                <div data-v-b8f60a0c="" class="break-25"></div>
                                <div data-v-b8f60a0c="" class="d-table">
                                    <div data-v-b8f60a0c="" class="d-table">
                                        <div data-v-b8f60a0c="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 1px solid {{$color}}; border-top: 1px solid {{$color}};">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-th w-2">{{__('Qty')}}</div>
                                            <div data-v-b8f60a0c="" class="d-table-th w-3 text-right">{{__('Amount')}}</div>
                                        </div>
                                                ...
                                                @foreach($estimation->getProducts as $key => $item)
                                                    <div data-v-b8f60a0c="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-b8f60a0c="" class="d-table-td w-13">
                                                            <pre data-v-b8f60a0c="">{{$item->name}}<br data-v-b8f60a0c=""></pre>
                                                        </div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-3"><span data-v-b8f60a0c="">{{$usr->priceFormat($item->pivot->price)}}</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-2"><span data-v-b8f60a0c="">{{$item->pivot->quantity}}</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-3 text-right"><span data-v-b8f60a0c="">{{$usr->priceFormat($item->pivot->price * $item->pivot->quantity)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-b8f60a0c="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-td w-3"><span data-v-b8f60a0c="">-</span></div>
                                                    <div data-v-b8f60a0c="" class="d-table-td w-2"><span data-v-b8f60a0c="">-</span></div>
                                        ...
                                        <div data-v-b8f60a0c="" class="d-table-footer">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-summary">
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal())}}</div>
                                                </div>
                                                @if($estimation->discount)
                                                    <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                        <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($estimation->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($estimation->getTax())
                                                    <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                        <div data-v-b8f60a0c="" class="tu d-table-label">{{$estimation->tax->name}} ({{$estimation->tax->rate}}%):</div>
                                                        <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($estimation->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-b8f60a0c="" class="d-table-summary-item" style="color: {{$font_color}}; background: {{$color}};">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
