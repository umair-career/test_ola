                            ...
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="" class="row">
                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5"
                                                                                   style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('ESTIMATION')}}</strong>
                                        <table data-v-37eeda86="" class="summary-table">
                                            <tbody data-v-37eeda86="">
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Number')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$usr->estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Issue Date')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$usr->dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <div data-v-37eeda86="" class="d-table-footer">
                                            ...
                                            <div class="d-table-summary">
                                                <div class="d-table-summary-item">
                                                    ...
                                                    <div
                                                        class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal())}}</div>
                                                </div>
                                                @if($estimation->discount)
                                                    <div class="d-table-summary-item">
                                                        <div class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div
                                                            class="d-table-value">{{$usr->priceFormat($estimation->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($estimation->getTax())
                                                    <div class="d-table-summary-item">
                                                        <div class="tu d-table-label">
                                                            {{$estimation->tax->name}} ({{$estimation->tax->rate}}%):
                                                        </div>
                                                        <div class="d-table-value">{{$usr->priceFormat($estimation->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div class="d-table-summary-item"
                                                     style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    <div class="tu d-table-label">{{__('Total')}}:</div>
                                                    <div class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
