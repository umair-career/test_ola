                        ...
                        <div data-v-363339a0="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-3"><h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('ESTIMATION')}}</h1>
                                        ...
                                        <p data-v-363339a0="">@if($settings['company_country']) {{$settings['company_country']}}@endif</p>
                                    </div>
                                ...
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-66">
                                        ...
                                        <p data-v-363339a0="">{{$client->name}}</p>
                                        <pre data-v-363339a0="">{{$client->email}}</pre>
                                    </div>
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{$usr->estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$usr->dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 2px solid {{$color}}; border-top: 2px solid {{$color}};">
                                            ...
                                            <div data-v-363339a0="" class="d-table-th w-3 text-right">{{__('Amount')}}</div>
                                        </div>
                                                ...
                                                @foreach($estimation->getProducts as $key => $item)
                                                    <div data-v-363339a0="" class="d-table-tr">
                                                        ...
                                                        <div data-v-363339a0="" class="d-table-td w-13">
                                                            <pre data-v-363339a0="">{{$item->name}}<br data-v-363339a0=""></pre>
                                                        </div>
                                                        <div data-v-363339a0="" class="d-table-td w-3"><span data-v-363339a0="">{{$usr->priceFormat($item->pivot->price)}}</span></div>
                                                        <div data-v-363339a0="" class="d-table-td w-2"><span data-v-363339a0="">{{$item->pivot->quantity}}</span></div>
                                                        <div data-v-363339a0="" class="d-table-td w-3 text-right"><span data-v-363339a0="">{{$usr->priceFormat($item->pivot->price * $item->pivot->quantity)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-363339a0="" class="d-table-tr">
                                                    ...
                                                    <div data-v-363339a0="" class="d-table-td w-3"><span data-v-363339a0="">-</span></div>
                                                    <div data-v-363339a0="" class="d-table-td w-2"><span data-v-363339a0="">-</span></div>
                                        ...
                                        <div data-v-363339a0="" class="d-table-footer">
                                            ...
                                            <div data-v-363339a0="" class="d-table-summary">
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal())}}</div>
                                                </div>
                                                @if($estimation->discount)
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($estimation->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($estimation->getTax())
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{$estimation->tax->name}} ({{$estimation->tax->rate}}%):</div>
                                                        <div data-v-363339a0="" class="d-table-value">{{$usr->priceFormat($estimation->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="fwb f-b tu d-table-label" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Total')}}:</div>
                                                    <div data-v-363339a0="" class="fwb f-b d-table-value" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{$usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
