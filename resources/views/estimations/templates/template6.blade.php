                        ...
                        <div data-v-4b3dcb8a="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-3"><h1 data-v-4b3dcb8a="" class="fancy-title mb5">{{__('ESTIMATION')}}</h1></div>
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            ...
                                            <strong data-v-4b3dcb8a="" class="sub-title">{{$client->name}}</strong>
                                            <pre data-v-4b3dcb8a="">{{$client->email}}</pre>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-33">
                                        <table data-v-4b3dcb8a="" class="summary-table">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                ...
                                                <td data-v-4b3dcb8a="" class="text-right">{{$usr->estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{$usr->dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                            ...
                                            @if(isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                @foreach($estimation->getProducts as $key => $item)
                                                    <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3"><span data-v-4b3dcb8a="">{{$usr->priceFormat($item->pivot->price)}}</span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-2"><span data-v-4b3dcb8a="">{{$item->pivot->quantity}}</span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3 text-right"><span data-v-4b3dcb8a="">{{$usr->priceFormat($item->pivot->price * $item->pivot->quantity)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                        ...
                                        <div data-v-4b3dcb8a="" class="d-table-footer">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-summary">
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal())}}</div>
                                                </div>

                                                @if($estimation->discount)
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{$usr->priceFormat($estimation->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($estimation->getTax())
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{$estimation->tax->name}} ({{$estimation->tax->rate}}%):</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{$usr->priceFormat($estimation->getTax())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><strong data-v-4b3dcb8a="">{{__('Total')}}:</strong></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><strong data-v-4b3dcb8a="">{{$usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())}}</strong></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
