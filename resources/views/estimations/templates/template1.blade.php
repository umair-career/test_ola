                                ...
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{$usr->estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Issue Date')}}:</td>
                                                <td>{{$usr->dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal())}}</div>
                                                    </div>
                                                    @if($estimation->discount)
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($estimation->discount)}}</div>
                                                        </div>
                                                    @endif
                                                    @if($estimation->getTax())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{$estimation->tax->name}} ({{$estimation->tax->rate}}%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($estimation->getTax())}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$border_color}}; border-bottom: 1px solid {{$border_color}};">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
