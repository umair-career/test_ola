                            ...
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9="" src="{{$img}}" class="d-logo" style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        ...
                                        <p data-v-1ad6e3b9="">@if($settings['company_country']) {{$settings['company_country']}}@endif</p>
                                    </div>
                                    <div data-v-1ad6e3b9="" class="col-33">&nbsp;</div>
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('ESTIMATION')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            <tbody data-v-1ad6e3b9="">
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Number')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$usr->estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{$usr->dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div data-v-1ad6e3b9="" class="row">
                                        <div data-v-1ad6e3b9="" class="col-2">
                                            <div data-v-1ad6e3b9="" class="col-66">
                                                ...
                                                <strong data-v-1ad6e3b9="" class="sub-title">{{$client->name}}</strong>
                                                <pre data-v-1ad6e3b9="">{{$client->email}}</pre>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div data-v-1ad6e3b9="" class="d-table">
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="tu d-table-tr" style="background: {{$color}};color: {{$font_color}}">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-th w-3 text-right" style="padding: 5px;">{{__('Amount')}}</div>
                                            </div>
                                                    ...
                                                    @foreach($estimation->getProducts as $key => $item)
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-13" style="border: 1px solid {{$color}}; padding: 5px;">
                                                                <pre data-v-1ad6e3b9="">{{$item->name}}<br data-v-1ad6e3b9=""></pre>
                                                            </div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$usr->priceFormat($item->pivot->price)}}</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-2" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$item->pivot->quantity}}</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3 text-right" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$usr->priceFormat($item->pivot->price * $item->pivot->quantity)}}</span></div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-1ad6e3b9="" class="d-table-tr">
                                            ...
                                            <div data-v-1ad6e3b9="" class="d-table-footer">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-summary">
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal())}}</div>
                                                    </div>
                                                    @if($estimation->discount)
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($estimation->discount)}}</div>
                                                        </div>
                                                    @endif
                                                    @if($estimation->getTax())
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">{{$estimation->tax->name}} ({{$estimation->tax->rate}}%):</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">{{$usr->priceFormat($estimation->getTax())}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label"><strong data-v-1ad6e3b9="">{{__('Total')}}:</strong></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value"><strong data-v-1ad6e3b9="">{{$usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())}}</strong></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
