    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create constant category')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('product-category.create') }}" data-ajax-popup="true" data-title="{{__('Create New Category')}}" class="btn btn-xs btn-white btn-icon-only width-auto">
